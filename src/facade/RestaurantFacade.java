...
public class RestaurantFacade {
	...
	public Facture payerCommande(Commande commande) {
		commande.calculerMontant();
		Facture facture = new Facture(commande, commande.getMontantTotal());
		facture.setPayee(true);
		System.out.println("Facture payée pour le montant de : " + facture.getMontantAPayer() + "€");
		return facture;
	}
